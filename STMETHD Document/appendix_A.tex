...
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{General_Research_Ethics_Checklist.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{RESEARCH ETHICS REVIEW FORM.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{Checklist A - Human Participants.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{Checklist G - Internet.pdf}
