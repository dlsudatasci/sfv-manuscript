...
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{ethics_forms/General_Research_Ethics_Checklist.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{ethics_forms/Checklist A - Human Participants.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{ethics_forms/Checklist G - Internet.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{ethics_forms/Informed Consent Form.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{ethics_forms/THS-ST1 Signed Research Ethics Review Form.pdf}
