...
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{appendices/Ethics_Review_Form_Flattened.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{appendices/General Research Ethics Checklist.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{appendices/[Specific Checklists] Checklist A - Human Participants.pdf}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{appendices/[Specific Checklists] Checklist G - Internet.pdf}


% \includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{clearance-final-signed_uc.pdf}

% \includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{general-final.pdf}

% \includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{checklistA-final.pdf}


\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{appendices/informed_consent_form.pdf}