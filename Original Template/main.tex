...
\include{chapter_5}               %-- includes LaTeX source file for Chapter 5: WeCyclePH 

\include{chapter_6}                 %-- includes LaTeX source file for Chapter 6: 

\include{chapter_7}                 %-- includes LaTeX source file for Chapter 7: Results and Discussion 

\include{chapter_8}                 %-- includes LaTeX source file for Chapter 8: Conclusion and Recommendation 


\appendix                         %-- used to specify appendices
\include{appendices/appendix_A}              %-- includes LaTeX source file for Appendix A
